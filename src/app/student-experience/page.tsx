  ...
  return (
    <>
      <section className="grain-overlay bg-[var(--color-ink)] py-24 md:py-32">
        <Container>
          <Reveal>
            <p className="eyebrow text-[var(--color-gold-bright)]">Student Experience</p>
        ...
        <RevealGroup className="section-container grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {categories.map((c) => (
            <RevealItem key={c.label}>
              ...
              <h3 className="mt-4 font-display font-medium text-[1.15rem] text-[var(--color-ink)]">{c.label}</h3>
