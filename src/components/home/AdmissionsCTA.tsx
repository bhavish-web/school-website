...
export function AdmissionsCTA() {
  return (
    <section className="grain-overlay relative overflow-hidden bg-[var(--color-forest)] py-20">
      <div
      ...
      <Container className="relative flex flex-col items-start gap-8 md:flex-row md:items-center md:justify-between">
        <Reveal>
          <h2 className="heading-tight font-display font-medium text-[1.9rem] font-medium leading-tight text-white md:text-[2.4rem]">
